...
async function seedDatabase() {
    try {
        ...
        const existingUsers = await database_1.databaseService.getAllUsers();
        ...
        for (const user of sampleUsers) {
            try {
                await database_1.databaseService.createUser(user);
                successCount++;
        ...
        // Display all users
        const allUsers = await database_1.databaseService.getAllUsers();
